...
export const UKRAINE_REGIONS: Region[] = [
  ...
  { id: "chernihiv", nameUa: "Чернігівська", nameEn: "Chernihiv", position: "left" },
  { id: "chernivtsi", nameUa: "Чернівецька", nameEn: "Chernivtsi", position: "left" },
  { id: "cherkasy", nameUa: "Черкаська", nameEn: "Cherkasy", position: "left" },
  { id: "khmelnytskyi", nameUa: "Хмельницька", nameEn: "Khmelnytskyi", position: "left" },
  { id: "kherson", nameUa: "Херсонська", nameEn: "Kherson", position: "left" },
  { id: "ternopil", nameUa: "Тернопільська", nameEn: "Ternopil", position: "left" },
  ...
  { id: "mykolaiv", nameUa: "Миколаївська", nameEn: "Mykolaiv", position: "left" },
  ...
  { id: "kirovohrad", nameUa: "Кіровоградська", nameEn: "Kirovohrad", position: "right" },
  { id: "kyiv-oblast", nameUa: "Київська", nameEn: "Kyiv Oblast", position: "right" },
  { id: "zaporizhzhia", nameUa: "Запорізька", nameEn: "Zaporizhzhia", position: "right" },
  { id: "zakarpattia", nameUa: "Закарпатська", nameEn: "Zakarpattia", position: "right" },
  { id: "ivano-frankivsk", nameUa: "Івано-Франківська", nameEn: "Ivano-Frankivsk", position: "right" },
  { id: "donetsk", nameUa: "Донецька", nameEn: "Donetsk", position: "right" },
  { id: "dnipro", nameUa: "Дніпропетровська", nameEn: "Dnipro", position: "right" },
